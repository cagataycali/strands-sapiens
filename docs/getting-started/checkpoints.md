...
└── detector/
    └── rtmdet_m.pth                      # required for pose
```
...
- **Person detector** (`rtmdet_m.pth`): [facebook/sapiens-pose-bbox-detector](https://huggingface.co/facebook/sapiens-pose-bbox-detector).
